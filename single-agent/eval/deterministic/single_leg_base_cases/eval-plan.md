...
- **User Input:** Create eight routine single-leg evaluations covering both
  ...
  checks manually, and run live agent cases and simulations only when authorized;
...
| 2026-08-11 | Automation | Live agent execution left required CI because deterministic grading does not make model execution deterministic. |
...
| 2026-08-14 | Automation | Completed | All eval execution is manual; live code-graded and simulated runs require explicit authorization. |
