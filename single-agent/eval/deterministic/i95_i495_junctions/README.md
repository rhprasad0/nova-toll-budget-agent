...
Run the synthetic check manually first. The live model execution and its
simulated-user companion are explicitly authorized observations; deterministic
grading still rejects duplicate successful or incorrect tool trajectories, and
the dedicated duplicate-tool-guard suite grades valid cancellations.
