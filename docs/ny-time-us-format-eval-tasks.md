...
- [ ] Write `eval/deterministic/ny_time_us_format/eval-plan.md`.
- [ ] Write `eval/deterministic/ny_time_us_format/test-cases.jsonl` (3 cases,
      real oracle pair + data range verified against RDS first).
- [ ] Write `eval/deterministic/ny_time_us_format/deterministic_ny_time_us_format.py`
...
- [ ] Write `eval/deterministic/ny_time_us_format/README.md`.
