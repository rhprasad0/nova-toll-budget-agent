...
below; its raw report remains archived.

**Complete measurement; human approval pending.** This run calibrates the more realistic cases 79 and 80 requested by Ryan. Open the [raw report](calibration-3/report.json) for complete transcripts, tool evidence, labels, and judge explanations.
