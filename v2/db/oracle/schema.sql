...
BEGIN
    IF current_setting('server_version_num')::integer < 170000
       OR current_setting('server_version_num')::integer >= 180000 THEN
        RAISE EXCEPTION 'oracle 1.2.1 requires PostgreSQL 17';
    END IF;
    IF to_regclass('pricing.schema_version') IS NULL
       OR to_regclass('pricing.current_i95_direction') IS NULL THEN
        RAISE EXCEPTION 'oracle 1.2.1 requires pricing schema 1.x';
    END IF;
    ...
    IF pricing_version IS NULL
       ...
       OR pricing_version_parts >= ARRAY[2, 0, 0] THEN
        RAISE EXCEPTION 'oracle 1.2.1 requires pricing schema 1.x; found %',
...
BEGIN
    ...
    IF installed_version !~ '^3[.]5([.]|$)' THEN
        RAISE EXCEPTION 'oracle 1.2.1 requires PostGIS 3.5.x; found %',
...
INSERT INTO oracle.schema_version (version) VALUES ('1.2.1');
