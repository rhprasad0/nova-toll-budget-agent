...
- **Status:** Adopted for oracle schema `1.14.1`
...
oracle is at version `1.14.1`, stored as the single row in
...
- `oracle.schema_version` contains exactly one row at `1.14.1`, its canonical
