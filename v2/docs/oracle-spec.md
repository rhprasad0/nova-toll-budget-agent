...
- **Status:** Adopted for oracle schema `1.10.0`
...
oracle is at version `1.10.0`, stored as the single row in
...
- `oracle.schema_version` contains exactly one row at `1.10.0`, its canonical
