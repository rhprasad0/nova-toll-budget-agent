...
def test_i66_route_module_imports_without_psycopg():
    # psycopg is a real dependency now (pyproject.toml), but env_connect()
    ...
    from agent_tools import i66_route  # noqa: F401

    assert "psycopg" not in sys.modules


def test_i95_route_module_imports_without_psycopg():
    from agent_tools import i95_route  # noqa: F401

    assert "psycopg" not in sys.modules


def test_i495_route_module_imports_without_psycopg():
    from agent_tools import i495_route  # noqa: F401
